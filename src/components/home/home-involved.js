...
const HomeInvolved = () => {
  return (
    <Container className="cb-home-involved-container">
      <Row>
        <Col lg={6} md={12} sm={12}>
          <h1 className="cb-home-involved-title">Want to get involved?</h1>
          <p className="cb-home-involved-description">
            Reach out to us through email or social media! You can also connect
            with us through our contact forms.
          </p>
        ...
        <Col lg={3} md={6} sm={6}>
          ...
          <p className="cb-home-involved-description">
            We are looking for companies and non-profits with exciting projects
            to work with. If you have a project for us, please reach out!
          </p>
          <Link className="cb-home-involved-link" to="/contact">
            Contact Us →
          </Link>
        </Col>
